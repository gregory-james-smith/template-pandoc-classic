\typeout{ENGINE: \directlua{tex.print("LuaLaTeX")} }
...
% Fallback for Greek, Cyrillic, Georgian
\directlua{
  luaotfload.add_fallback("free_fallback", {
    "FreeSerif:mode=harf"
  })
}

% Main EB Garamond font (bundled)
\setmainfont[
  ...
  RawFeature={fallback=free_fallback},
  Ligatures=TeX,
  Scale=1
]{EBGaramond}

% Math font (from TeX Live)
