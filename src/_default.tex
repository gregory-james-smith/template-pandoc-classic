...
% Strikeout, underline and crossout support
\usepackage[normalem]{ulem}
% Redefine \st to use a thin, elegant strikeout
% \renewcommand{\st}[1]{%
%   \bgroup
%     \ULdepth=-.5ex % vertical position of the line
%     \ULthickness=0.1ex % thin rule for Classic Thesis aesthetic
%     \sout{#1}%
%   \egroup
% }
\typeout{DEBUG: ulem LOADED HERE}
...
% Palatino as main text font
\usepackage{fontspec}
\setmainfont{TeX Gyre Pagella}[Ligatures=TeX] % Palatino clone

% EB Garamond Math as math font
\usepackage{unicode-math}
\setmathfont{TeX Gyre Pagella Math}
% \setmathfont{Garamond-Math}
% Selectively replace math font with ranges
% \setmathfont{Latin Modern Math}[range={up, it, bfup, bfit}, Scale=MatchLowercase]

% Fallback chain for Greek, Cyrillic, IPA, symbols
% \directlua{
%   luaotfload.add_fallback("global_fallback", {
%     "FreeSerif:mode=harf",          -- Greek, Cyrillic, IPA, extended Latin
%     "Symbola:mode=harf",            -- Misc symbols, arrows, dingbats
%     "Noto Sans Symbols:mode=harf",  -- Emoji, rare Unicode blocks
%     "Noto Sans Symbols2:mode=harf"  -- Supplemental symbols
%   })
% }

% Apply fallback to all fonts
\defaultfontfeatures{RawFeature={fallback=global_fallback}}

% Optional: better Palatino small caps & oldstyle numerals
